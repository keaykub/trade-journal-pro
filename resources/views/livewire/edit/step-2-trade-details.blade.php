{{-- resources/views/trades/partials/step-2-trade-details.blade.php --}}
<div class="bg-white/80 dark:bg-slate-800/80 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 dark:border-slate-700/50 overflow-hidden">
    ...
    <div class="p-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {{-- Price Fields --}}
            @include('livewire.edit.price-fields')

            {{-- Order Details --}}
            @include('livewire.edit.order-details')
        </div>

        {{-- Real-time Analysis Panel --}}
        @include('livewire.edit.analysis-panel')
    </div>
</div>
