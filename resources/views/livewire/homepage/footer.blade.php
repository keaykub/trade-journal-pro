        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
                ...
                <ul class="space-y-2 text-gray-400">
                    <li><a href="{{-- {{ route('features.journal') }} --}}" class="hover:text-white transition-colors">บันทึกการเทรด</a></li>
                    <li><a href="{{-- {{ route('features.analytics') }} --}}" class="hover:text-white transition-colors">วิเคราะห์สถิติ</a></li>
                    <li><a href="{{-- {{ route('features.ai-coach') }} --}}" class="hover:text-white transition-colors">AI โค้ช</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2 text-gray-400">
                    ...
                    <li><a href="{{-- {{ route('blog') }} --}}" class="hover:text-white transition-colors">บล็อก</a></li>
            ...
            <div>
                ...
                <ul class="space-y-2 text-gray-400">
                    ...
                    <li><a href="{{-- {{ route('help') }} --}}" class="hover:text-white transition-colors">วิธีใช้งาน</a></li>
                    <li><a href="{{-- {{ route('support') }} --}}" class="hover:text-white transition-colors">สนับสนุน</a></li>
                </ul>
            </div>
        </div>

        <div class="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p class="text-gray-400">© {{ $currentYear }} Trade Journal. Made for traders, by traders.</p>
