    ...
    <div class="max-w-7xl mx-auto px-6 py-4">
        <div class="flex justify-between items-center">
            ...
            <nav class="hidden md:flex items-center space-x-8 text-gray-700">
                ...
                <a href="{{ route('faq') }}"
                class="transition-colors font-medium relative group {{ request()->routeIs('faq') ? 'text-blue-600' : 'text-gray-700 hover:text-blue-600' }}">
                    คำถามที่พบบ่อย
                    <span class="absolute bottom-0 left-0 h-0.5 bg-blue-600 transition-all duration-300 {{ request()->routeIs('faq') ? 'w-full' : 'w-0 group-hover:w-full' }}"></span>
                </a>
