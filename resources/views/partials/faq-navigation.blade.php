    ...
    <div class="max-w-7xl mx-auto px-6 py-4">
        <div class="flex justify-between items-center">
            ...
            <nav class="hidden md:flex items-center space-x-8">
                <a href="{{ route('pricing') }}" class="text-gray-600 hover:text-blue-600 transition-colors">แผนราคา</a>
                <a href="{{ route('faq') }}" class="text-blue-600 font-semibold">คำถามที่พบบ่อย</a>
        ...
        <nav x-show="open" x-transition class="md:hidden mt-4 pb-4">
            <div class="flex flex-col space-y-4">
                <a href="{{ route('pricing') }}" class="text-gray-600">แผนราคา</a>
                <a href="{{ route('faq') }}" class="text-blue-600 font-semibold">คำถามที่พบบ่อย</a>
